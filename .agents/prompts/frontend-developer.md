...
export class Task {
  constructor(public readonly id: string, public title: string,
              public status: TaskStatus, public dueDate: Date) {}
  complete(): void {
    if (this.status === TaskStatus.DONE) throw new DomainError("Task already completed");
    if (this.dueDate < new Date()) throw new DomainError("Cannot complete overdue task without review");
...
export class CompleteTaskUseCase {
  constructor(private repo: ITaskRepository, private gateway: ITaskStateGateway) {}
